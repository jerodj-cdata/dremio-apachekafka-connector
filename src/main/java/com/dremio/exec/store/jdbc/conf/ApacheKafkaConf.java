...
@SourceType(value = "ApacheKafkaARP", label = "ApacheKafka",uiConfig = "apachekafka-layout.json")
public class ApacheKafkaConf extends AbstractArpConf<ApacheKafkaConf> {
  private static final String ARP_FILENAME = "arp/implementation/apachekafka-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.apachekafka.ApacheKafkaDriver";
